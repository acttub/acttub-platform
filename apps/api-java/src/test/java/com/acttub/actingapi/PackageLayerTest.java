...
class PackageLayerTest {
     ...
     *
     * <p>아직 못 거는 규칙이 하나 있다 — <b>feature끼리 직접 import 금지</b>. {@code practice}가
     * 여전히 {@code operation}(6단계)·{@code auth}(7단계)·{@code storage}·{@code web}(8단계)을
     * 직접 참조하므로, 그 셋이 끝난 뒤에 붙는다. 13단계에서 한정을 풀 때 함께 넣는다.
     */
