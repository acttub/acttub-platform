package com.acttub.actingapi.feature.practice.adapter.storage;

import java.util.Optional;

import com.acttub.actingapi.feature.practice.app.PracticePlayback;
 ...
 */
@Component
class ObjectStoragePlayback implements PracticePlayback {
    private final Optional<ObjectStorage> configured;

    ObjectStoragePlayback(Optional<ObjectStorage> configured) {
