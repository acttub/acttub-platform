...
export const createAiPipelineService = (incomingDeps) => {
    ...
    const createServiceError = deps.createServiceError ?? ((stage, code, status, retryable) => Object.assign(new Error(code), { stage, code, status, retryable }));
