...
export interface PipelineTurnInput { sessionId:string; userId:string; agentRunId:string; expectedSubstantiveAnswerCount:number; expectedTotalConversationCount:number; actorTurn:InterviewTurn|null; agentTurn:InterviewTurn; model:string; promptVersion:string; currentInput:{command:"start"|"observation_update"|"answer"|"manual_stop"|"resume";answer:string|null;answerTurnId:string|null;observationId:string|null}; reportEvidence:{observationIds:string[];answerTurnIds:string[]} }
