...
public class SummaryEntity extends AppGeneratedUuidEntity {
    ...
    @Column(name = "was_compressed", nullable = false)
    ...
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "observations_json", nullable = false, columnDefinition = "jsonb")
    JsonNode observationsJson;

    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "uncertainties_json", nullable = false, columnDefinition = "jsonb")
    JsonNode uncertaintiesJson;
    ...
    public JsonNode getObservationsJson() {
