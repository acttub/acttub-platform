...
@Entity
@Table(name = "community_anonymous_aliases")
public class CommunityAnonymousAliasEntity extends AppGeneratedUuidEntity {
    ...
    protected CommunityAnonymousAliasEntity() {
    }

    public CommunityAnonymousAliasEntity(UUID id, UUID postId, UUID userId, int ordinal) {
        super(id);
        this.postId = postId;
        this.userId = userId;
