...
public class ExternalOperationEntity extends AppGeneratedUuidEntity {
    ...
    protected ExternalOperationEntity() {
    }

    public ExternalOperationEntity(UUID id, UUID sessionId, UUID userId, UUID requestId,
            OperationKind kind, OperationStatus status, String fingerprint) {
        super(id);
