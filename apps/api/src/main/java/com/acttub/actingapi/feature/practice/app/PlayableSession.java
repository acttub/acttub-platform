...
public record PlayableSession(
    ...
    public PlayableSession(PracticeSession session, String playbackUrl, ObservationPack summary, String errorCode) {
        this(session, playbackUrl, summary, errorCode, null);
    }
}
