...
public class CoachingHandoffEntity extends AppGeneratedUuidEntity {
    ...
    @JdbcTypeCode(SqlTypes.JSON) @Column(name="handoff_json",nullable=false,columnDefinition="jsonb") JsonNode handoffJson; @Column(name="created_at",nullable=false,insertable=false,updatable=false) Instant createdAt;
    protected CoachingHandoffEntity(){} public CoachingHandoffEntity(UUID id,UUID coachSessionId,UUID practiceSessionId,String branchKind,JsonNode handoffJson){super(id);this.coachSessionId=coachSessionId;this.practiceSessionId=practiceSessionId;this.branchKind=branchKind;this.handoffJson=handoffJson;}
}
