...
public class PracticeReportEntity extends AppGeneratedUuidEntity {
    ...
    @Column(name = "source_handoff_id", nullable = false)
    UUID sourceHandoffId;

    @Column(name = "created_at", nullable = false, insertable = false, updatable = false)
    Instant createdAt;

    protected PracticeReportEntity() {
    }

    public PracticeReportEntity(UUID id, UUID practiceSessionId, String reportType,
            JsonNode reportJson, UUID sourceHandoffId) {
        super(id);
        this.practiceSessionId = practiceSessionId;
        this.reportType = reportType;
        this.reportJson = reportJson;
        this.sourceHandoffId = sourceHandoffId;
    }
}
