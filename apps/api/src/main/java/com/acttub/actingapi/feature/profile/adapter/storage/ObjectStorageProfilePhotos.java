package com.acttub.actingapi.feature.profile.adapter.storage;

import java.util.Optional;

import com.acttub.actingapi.feature.profile.app.ProfilePhotoStorage;
 ...
 */
@Component
class ObjectStorageProfilePhotos implements ProfilePhotoStorage {
    private final Optional<ObjectStorage> configured;

    ObjectStorageProfilePhotos(Optional<ObjectStorage> configured) {
