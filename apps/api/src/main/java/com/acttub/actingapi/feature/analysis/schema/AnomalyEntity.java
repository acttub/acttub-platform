...
public class AnomalyEntity {
    ...
    @Column(name = "why_odd", nullable = false)
    String whyOdd;

    @Column(name = "likely_cause", nullable = false)
    String likelyCause;

    @Column(name = "impact_on_intent", nullable = false)
    String impactOnIntent;

    @Column(name = "overlaps_key_moment", nullable = false)
    boolean overlapsKeyMoment;

    @Column(name = "on_key_dimension", nullable = false)
    ...
    public AnomalyEntity(UUID summaryId, IntentImpact impact, Severity severity) {
        ...
        this.whyOdd = "o";
        this.likelyCause = "c";
        this.impactOnIntent = "i";
        this.intentImpact = impact;
        this.severity = severity;
        this.severityReason = "r";
    }
}
