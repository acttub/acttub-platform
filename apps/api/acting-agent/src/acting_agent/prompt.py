...
배우가 UI에서 “이제 맞아요”를 눌러 해당 handoff를 확인한 뒤에만 3층 분석 리포트로 넘어간다.
...
* status complete를 3층 리포트 생성 완료로 취급하기
...
배우가 UI에서 “이제 맞아요”를 눌러 해당 handoff를 확인한 뒤에만 3층 표현 리포트로 넘어간다.
...
대신 3층 리포트 AI가 훈련을 추천할 수 있도록 다음 정보를 handoff에 남긴다.
